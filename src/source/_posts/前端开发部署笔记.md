...
- 为了解决强缓存更新问题，将文件摘要（hash）作为资源路径(URL)构成的一部分。出现以下问题![](http://rfxd3bqqt.hn-bkt.clouddn.com/blog/Ftlrcp0ImiDFxC27bcT8AGZK5Tab.png)
...
![](http://rfxd3bqqt.hn-bkt.clouddn.com/blog/FswP-gr7A3SBfp1BpeCXyubUoJ4_.png)
